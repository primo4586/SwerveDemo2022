...
public class LoggableFollowCommand extends CommandBase {
  ...
  public void execute() {
      ...
      SmartDashboard.putNumber("Target rotation", desiredState.holonomicRotation.getDegrees());
